...
#========================================================
puts "id calendario: $id_calendario id modalidad: $id_modalidad id periodo: $id_periodo id categoria: $id_categoria"
#========================================================
...
foreach comunidad $comu_calendar {
	...
	if { $com == $val_com1 } { 		
		puts "comunidades de calendario $com"
