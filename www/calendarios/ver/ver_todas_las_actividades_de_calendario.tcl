#tda-cal-inac/www/calendarios/ver/ver_todas_las_actividades_de_calendario.tcl
ad_page_contract {
...
template::list::create \
	...
	if {$id_categoria eq "%"} {
        td_inac_procs::obtener_actividades_por_modalidad_todas_categorias -id_modalidad "O" -id_calendario $id_calendario -multirow actividades_especiales
        td_inac_procs::obtener_actividades_por_modalidad_todas_categorias_periodo -id_modalidad "S" -periodo $periodo -id_calendario $id_calendario -multirow actividades_semestre
		td_inac_procs::obtener_actividades_por_modalidad_todas_categorias_periodo -id_modalidad "C" -periodo $periodo -id_calendario $id_calendario -multirow actividades_cuatrimestre
		td_inac_procs::obtener_actividades_por_modalidad_todas_categorias_periodo -id_modalidad "T" -periodo $periodo -id_calendario $id_calendario -multirow actividades_trimestre	
		td_inac_procs::obtener_actividades_por_modalidad_todas_categorias_periodo -id_modalidad "B" -periodo $periodo -id_calendario $id_calendario -multirow actividades_bimestre
		td_inac_procs::obtener_actividades_por_modalidad_todas_categorias_periodo -id_modalidad "M" -periodo $periodo -id_calendario $id_calendario -multirow actividades_mensual
	} else {
